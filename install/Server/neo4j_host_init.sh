...
NEOLOG="/home/neo4j/neo4j_install.log"
# specify the neo4j staging director used for Samba shares
#NEOSTAGE=/opt/neo4j
NEOREPO="/home/neo4j/repo/CSS"
BOOTSTRAPDIR="$NEOREPO/bootstrap"
INSTALLDIR="$NEOREPO/install/Server"
...
if [ -d $INSTALLDIR ]; then
	...
	echo "unable to locate install directory: $INSTALLDIR"
	echo "aborting script"
	echo "$(date) : Error : unable to locate install directory" >> $NEOLOG
fi
#------------------------------------------------
# Install a jdk
#------------------------------------------------
